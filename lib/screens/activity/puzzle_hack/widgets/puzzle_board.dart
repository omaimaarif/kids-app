...
import 'package:another_final_kids_app/screens/activity/puzzle_hack/widgets/puzzle_paint.dart';
import 'package:another_final_kids_app/screens/activity/puzzle_hack/widgets/puzzle_tile.dart';
...
class _ParticlePuzzleBoardState extends ConsumerState<ParticlePuzzleBoard>
  ...
  void _loadImagesAndResize() async {
    ...
    loadImageFromAssets('lib/assets/images/dropp.png').then((value) async {
    ...
    loadImageFromAssets('lib/assets/images/whitte.png').then((value) async {
