import 'dart:math';
import 'package:another_final_kids_app/screens/spell/progress_bar.dart';
...
class HomeSpell extends StatefulWidget {
  const HomeSpell({Key? key}) : super(key: key);

  @override
  State<HomeSpell> createState() => _HomeSpellState();
}

class _HomeSpellState extends State<HomeSpell> {
                ...
                children: [
                  ...
                  Expanded(
                      ...
                      child: FlyInAnimation(
                          animate: true,
                          child: Image.asset('assets/images_spel/$_dropWord.png'))),
                  Expanded(
                    flex: 3,
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
